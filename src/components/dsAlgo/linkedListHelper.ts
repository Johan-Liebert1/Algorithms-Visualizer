...
export const animateLinkedListNodeDeletion = async (
  ...
  */
    ...
    let nextNode: linkedListNodesList | paperJsNode =
        linkedListNodes[indexToDelete + 1];
    ...
    if (!previousNode) {
        ...
        setTimeout(() => {
            linkedListNodes = linkedListNodes.filter(
  ...
  */
    ...
    return new Promise((resolve) =>
        setTimeout(() => {
            ...
            // canvas
            linkedListNodes[indexToDelete].pointers.push(
                ...nodeToDelete.pointers
            );
            ...
            const group = new paper.Group([
                nodeToDelete.node.rect,
                nodeToDelete.node.text,
            ]);
