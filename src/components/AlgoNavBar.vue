        ...
        <div class="options-container">
            <div class="dropdown-container-container">
                ...
                >
                    <h1
                        class="is-size-4"
                        @click="algoDropdownVisible = !algoDropdownVisible"
                    >
                ...
                >
                    <h1
                        class="is-size-4"
                        @click="speedDropdownVisible = !speedDropdownVisible"
                    >
                ...
                <div
                    ...
                    class="dropdown-container"
                    :style="
                        cellSizeDropdownVisible ? dropdownStyle : normalStyle
                    "
                >
                    <h1
                        class="is-size-4"
                        @click="
                            cellSizeDropdownVisible = !cellSizeDropdownVisible
                        "
                    >
                        Cell Size <SVG :name="svgNames.downArrow" />
                    </h1>
                    <Dropdown
                        v-if="cellSizeDropdownVisible"
                        :dropdownItems="null"
                    >
                        <p>Size: {{ cellSize }}</p>
                        <input
                ...
                <div
                    ...
                    class="dropdown-container"
                    :style="
                        arraySizeDropdownVisible ? dropdownStyle : normalStyle
                    "
                >
                    <h1
                        class="is-size-4"
                        @click="
                            arraySizeDropdownVisible = !arraySizeDropdownVisible
                        "
                    >
                        Array Elements <SVG :name="svgNames.downArrow" />
                    </h1>
                    <Dropdown
                        v-if="arraySizeDropdownVisible"
                        :dropdownItems="null"
                    >
                ...
                >
                    <h1
                        class="is-size-4"
                        @click="mazeDropdownVisible = !mazeDropdownVisible"
                    >
