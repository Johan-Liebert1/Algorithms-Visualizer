        ...
        <div class="array-sort-container">
            <div class="algorithm-info has-text-centered">
                    ...
                    <Tooltip :tooltipMessage="TOOLTIPS.ITERATING_ELEMENTS">
                        <div class="is-flex" style="margin-top: 5px">
                            <div
                                class="cell-info-div"
                                :style="{
                                    backgroundColor: arrayColors.iterating,
                                }"
                            ></div>
                            Iterating
                        </div>
                ...
                <div v-if="yellowBarLegend.show">
                    <Tooltip
                        :tooltipMessage="
                            chosenSortingAlgorithm ===
                            allSortingAlgorithms.QUICK_SORT
...
export default defineComponent({
    ...
    methods: {
        ...
        swapElements(
            ...
            if (
                dontColorIdx !== index1 &&
                this.array[index1].barColor !== sortedBarColor
            )
                this.array[index1].barColor = swapBarColor;

            if (
                dontColorIdx !== index2 &&
                this.array[index2].barColor !== sortedBarColor
            )
        ...
        iteratingOverElements(
            ...
            return new Promise((r) =>
                setTimeout(r, Math.abs(index2 - index1) * interval)
            );
        },
